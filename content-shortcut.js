...
function validatePlugin(){
	...
	if( taskBar != null ){
		...
		const btnAtestadoMatricula = document.createElement("button")
		const btnIRPF = document.createElement("button")
		...
		function startShortcuts(){
			...
			insertBtn(btnAtestadoMatricula, "Atestado", "/registro_controle_academico/atestadoMatricula.php")
			insertBtn(btnIRPF, "IRPF", "/financeiro/impostoRenda.php")
			fillArea()
